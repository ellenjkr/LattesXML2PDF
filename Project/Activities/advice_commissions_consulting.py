class Advice_Commission_Consulting():
	def __init__(self, xml_content):
		super(Advice_Commission_Consulting, self).__init__()
	...
	def get_table_content(self, activity_info):
		activity_string = "Conselhos, Comissões e Consultoria"
		...
		activity_string += activity_info['specification']
