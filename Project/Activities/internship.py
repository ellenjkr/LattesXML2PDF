class Intership():
	...
	def get_table_content(self, activity_info):
		...
		activity_string += "\n\n"
		activity_string += "Estágio realizado\n"
		activity_string += activity_info['intership']
